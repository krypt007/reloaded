...
contract ERC20 is ERC20Data {
    ...
    function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external {
        require(block.timestamp < deadline, 'reLOAD2: Expired');
        ...
        require(recoveredAddress == owner, 'reLOAD2: Invalid Signature');
        allowance[owner][spender] = value;
        emit Approval(owner, spender, value);
    }
}

contract InvestorsVault is ERC20, Ownable { 
    using BoringMath for uint256;
    
    string public name = "InvestorsVault V2";
    string public symbol = "reLOAD2";
    uint8 public decimals = 18;
    IERC20 public load = IERC20(0x6B3595068778DD592e39A122f4f5a5cF09C90fE2);
    ...
    function setBonus(address sender, uint256 newBonus) public onlyOwner {
        require(newBonus <= 365 days, "InvestorsVault: Bonus too large");
    ...
    function enter(uint256 amount, address to) public {
        ...
        if (balanceCurrent == 0) {
            ...
            // If you added 100 LOAD 3 months ago and you add 200 LOAD now, startTime should become 1 month ago
        ...
        load.transferFrom(msg.sender, address(this), amount);
